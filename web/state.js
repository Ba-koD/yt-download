...
export const el = {
  ...
  useBrowserCookies: document.querySelector("#useBrowserCookies"),
  ...
  libraryPeriod: document.querySelector("#libraryPeriod"),
  libraryRange: document.querySelector("#libraryRange"),
  libraryFrom: document.querySelector("#libraryFrom"),
  libraryTo: document.querySelector("#libraryTo"),
